...
<body>
	...
	<s:if test="#request.poetContent.size() == 0 ">
		<div>
			<p
	...
	<s:else>
		<table class="table" style="margin-top: 2px">
			<s:if test="#request.poetSelect == '作者'">
				<tr class="alter">
					<th width="120px">诗人</th>
					<th width="600px">题目</th>
				</tr>
				<s:iterator value="#request.poetContent">
					<tr>
						<td><s:property value="poets.name" /></td>
						<td><s:property value="title" /></td>
					</tr>
				</s:iterator>
			</s:if>
			<s:elseif test="#request.poetSelect == '题目'">
				<tr class="alter">
					<th width="100">题目</th>
					<th width="500">内容</th>
				</tr>
			...
			<s:elseif test="#request.poetSelect == '内容'">
				<tr class="alter">
					<th width="60px">诗人</th>
