...
<body style="text-align:center">
	...
	<div class="submit-forms">
		<form action="checkPoet.action" method="post">
			<select name="ci.poetContentSelect" class="styled-select">
				<option>作者</option>
				<option>题目</option>
				<option>内容</option>
			</select>
			<input id="input_content" type="text" autofocus name="ci.searchPoet" size="30px" placeholder="请输入要搜索的诗词" /> 
